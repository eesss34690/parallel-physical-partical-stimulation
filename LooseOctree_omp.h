...
#if !defined(ST_LOOSEOCTREE_OMP_H)
#define ST_LOOSEOCTREE_OMP_H
...
{
    class LooseOctreeNode_omp;
    
    class LooseOctree_omp : public ISpatialStructure
    {
        public:
            
            LooseOctree_omp(const Vector3& refCenter, float f32HalfWidth, int i32Rebuild = 0);
            ~LooseOctree_omp();
        ...
        public:
            ...
            void                VUpdate();
            void                VUpdate_pthread(int start, std::vector<SpatialTest::ISpatialObject*>::iterator ending){}
        ...
        protected:
            ...
            LooseOctreeNode_omp*                        m_pRootNode;
            int                                     m_i32Rebuild;
    ...
    class LooseOctreeNode_omp : public ISpatialCell
    {      
        friend class LooseOctree_omp;
        
        public:
        
            LooseOctreeNode_omp(LooseOctreeNode_omp* pParent, const Vector3& refCenter, float f32HalfWidth, int i32Depth);
            ~LooseOctreeNode_omp();
        ...
        protected:
            ...
            LooseOctreeNode_omp*                m_pParent;
        
            // [rad] Children of this node
            LooseOctreeNode_omp*                m_pChildren[8];
