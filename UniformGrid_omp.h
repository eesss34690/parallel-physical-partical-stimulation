...
#if !defined(ST_UNIFORMGRID_OMP_H)
#define ST_UNIFORMGRID_OMP_H
...
{
    class UniformGridHashBucket_omp;

    class UniformGrid_omp : public ISpatialStructure
    {
        public:
            
            UniformGrid_omp(int i32HashBuckets = 1024);
            ~UniformGrid_omp();
        ...
        protected:
            ...
            std::vector<UniformGridHashBucket_omp*>     m_vecHashBuckets;
    ...
    class UniformGridHashBucket_omp : public ISpatialCell
    {
        public:
        
            UniformGridHashBucket_omp();
