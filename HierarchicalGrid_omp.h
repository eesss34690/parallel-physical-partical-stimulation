...
#if !defined(ST_HIERARCHICALGRID_OMP_H)
#define ST_HIERARCHICALGRID_OMP_H
...
{
    class HierarchicalGridHashBucket_omp;
    

    
    class HierarchicalGrid_omp : public ISpatialStructure
    {
        public:
        
            HierarchicalGrid_omp(int i32HashBuckets = 1024);
            ~HierarchicalGrid_omp();
        ...
        protected:
            ...
            std::vector<HierarchicalGridHashBucket_omp*>    m_vecHashBuckets;
    ...
    class HierarchicalGridHashBucket_omp : public ISpatialCell
    {
        public:

            HierarchicalGridHashBucket_omp();
...
#endif //!defined(ST_HIERARCHICALGRID_OMP_H)
