...
#if !defined(ST_OCTREE_OMP_H)
#define ST_OCTREE_OMP_H
...
{
    class Octree_ompNode;
    
    class Octree_omp : public ISpatialStructure
    {
        public:
            
            Octree_omp(const Vector3& refCenter, float f32HalfWidth, int i32Rebuild = 0);
            ~Octree_omp();
    ...
    class Octree_ompNode : public ISpatialCell
    {      
        friend class Octree_omp;
        
        public:
        
            Octree_ompNode(Octree_ompNode* pParent, const Vector3& refCenter, float f32HalfWidth, int i32Depth);
            ~Octree_ompNode();
        ...
        public:
            ...
            void                            CheckCollisions(std::vector<Octree_ompNode*>& refAncestors);
        ...
        protected:
            ...
            Octree_ompNode*                     m_pParent;
        
            // [rad] Children of this node
            Octree_ompNode*                     m_pChildren[8];
