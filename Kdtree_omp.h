...
#if !defined(ST_KDTREE_OMP_H)
#define ST_KDTREE_OMP_H
...
{
    class KDTreeNode_omp;
    
    
    class KDTree_omp : public ISpatialStructure
    {
        public:
        
            KDTree_omp(const Vector3& refCenter, float f32HalfWidth);
            ~KDTree_omp();
    ...
    class KDTreeNode_omp : public ISpatialCell
    {
        friend class KDTree_omp;
        
        
        public:
        
            KDTreeNode_omp(KDTreeNode_omp* pParent, int i32SplitPane);
            ~KDTreeNode_omp();
        ...
        protected:
            ...
            KDTreeNode_omp*                                     m_pParent;
            KDTreeNode_omp*                                     m_pChildLeft;
            KDTreeNode_omp*                                     m_pChildRight;
