...
namespace SpatialTest
{
    ...
    //--
    float UniformGrid_omp::s_f32ObjectCellRatio = 4.0f;
    float UniformGrid_omp::s_f32Epsilon = 0.0005f;
    ...
    //--
    unsigned int
    UniformGrid_omp::ComputeHashValue(int i32HashBuckets, int i32X, int i32Y, int i32Z)
    {
    ...
    //--
    UniformGrid_omp::UniformGrid_omp(int i32HashBuckets) :
        ISpatialStructure(),
        m_i32HashBuckets(i32HashBuckets),
        m_i32FrameCount(0),
        m_f32GridSize(1.0f)
    {
        UniformGridHashBucket_omp* pBucket;
        ...
        for(int i32Index = 0; i32Index < m_i32HashBuckets; i32Index++)
        {
            ...
            pBucket = new UniformGridHashBucket_omp();
    ...
    //--
    UniformGrid_omp::~UniformGrid_omp()
    {
        UniformGridHashBucket_omp* pBucket;
        
        // [rad] Delete all buckets
        std::vector<UniformGridHashBucket_omp*>::iterator iter_bucket;
        #pragma parallel omp for
    ...
    //--
    void
    UniformGrid_omp::VAddObjects(const std::vector<ISpatialObject*>& refObjects)
    {
    ...
    UniformGrid_omp::VUpdate()
    {
        ...
        for(iter_object = m_vecObjects.begin(); iter_object != m_vecObjects.end(); iter_object++)
        {
            ...
            pBucket = static_cast<UniformGridHashBucket_omp*>(pObject->VGetCell());
    ...
    //--
    UniformGridHashBucket_omp::UniformGridHashBucket_omp() :
        ISpatialCell(),
        m_i32LastFrame(0),
        m_i32ObjectCount(0),
        m_pObjects(NULL)
    ...
    inline 
    int
    UniformGridHashBucket_omp::GetLastFrame() const
    {
    ...
    //--
    void
    UniformGridHashBucket_omp::InsertObject(ISpatialObject* pObject)
    {
    ...
    //--
    void
    UniformGridHashBucket_omp::RemoveObject(ISpatialObject* pObject)
    {
        /*
    ...
    //--
    void
    UniformGridHashBucket_omp::CheckCollisions(int i32LastFrame, ISpatialObject* pObject)
    {        
